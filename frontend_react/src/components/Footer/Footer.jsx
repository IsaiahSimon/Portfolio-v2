...
const Footer = () => {
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      <div className="items-center grid-flow-col xs:place-self-center flex flex-wrap">
        ...
        <p>Copyright © 2022 - iSimonDev | Isaiah Simon - All right reserved</p>
      </div>
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end xs:place-self-center">
        <SocialMedia />
      </div>
    </footer>
  )
